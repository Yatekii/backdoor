...
def setup():
	opts, args = getopt.getopt(sys.argv[1:], '', ['create-db', 'create-user=', 'remove-user=', 'sound-file=', 'userlevel='])
	...
	if do_create_user:
		...
		create_user(engine, create_user_name, 0, hashlib.sha512(auth_token.encode('utf-8')).hexdigest(), secret, sound_file)
		print('Done.')
